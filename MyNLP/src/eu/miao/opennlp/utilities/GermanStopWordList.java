...
public class GermanStopWordList {

	private static GermanStopWordList instance = null;
	private static Hashtable<String, Double> m_Stopwords = null;

	private GermanStopWordList() {
		loadStopwords();
	}

	public static GermanStopWordList getGermanStopWordList() {
	      if(instance == null) {
	         instance = new GermanStopWordList();
	      }
	      return instance;
	}
