...
{
  /// <summary>
  /// Stellt eine Schnittstelle da mit deren Hilfe überprüft werden kann ob ein Transportauftrag momentan fahrbar ist
  /// </summary>
  public interface ITransportKoordinierung
  {
    /// <summary>
    /// Überprueft ob ein Tablar vom VTW zu einem Arbeitsplatz uebersgetzt werden kann
    /// </summary>
    /// <param name="tu"></param>
