...
public class ComponentModelBuilder {
	...
	public ComponentModelBuilder(WmsModel modelType,
			Namespace theOwnerPackage, CompositeComponent theComponent,
	...
	public void addVariableElments(CompositeComponent theComponent,
			Project activeProject) {
		DiagramPresentationElement diagramPresentationElement = Project
				.getProject(diagram).getDiagram(diagram);
