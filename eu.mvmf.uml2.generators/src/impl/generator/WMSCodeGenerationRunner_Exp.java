...
public class WMSCodeGenerationRunner_Exp extends JFrame {
...
//					properties.put("path", getPath());
					...
					boolean result = runner.run("src/workflow/generator0_exp.mwe",
							new NullProgressMonitor(), properties, slotContents);
					 System.out.println("Workflow 1: Started");
					 new WorkflowRunner()
					 .main(new String[] {
					 "src/workflow/workflow-gen/generator1_exp.mwe" });

					File srcDir = new File("src-gen-exp");
