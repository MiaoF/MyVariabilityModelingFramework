...
public class GettingStartedWithUML2 {
	...
	public static void main(String[] args)
		...
		org.eclipse.uml2.uml.Class usAddressClass = createClass(epo2Model,
			"USAddress", false);
		org.eclipse.uml2.uml.Class deAddressClass = createClass(epo2Model,
				"DEAddress", false);
		...
		createGeneralization(deAddressClass, addressClass);
		...
		createAttribute(deAddressClass, "strasse", stringPrimitiveType, 1, 1);
		createAttribute(deAddressClass, "stadt", stringPrimitiveType, 1, 1);
		createAttribute(deAddressClass, "staat", stringPrimitiveType, 1, 1);
		createAttribute(deAddressClass, "PLZ", stringPrimitiveType, 1, 1);
	...
	private static boolean processArgs()
		...
		outputDir = new File(currentPath).getCanonicalFile();
		if (!outputDir.exists()) {
