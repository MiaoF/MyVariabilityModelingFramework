...
namespace Sgm.Akl.LeerbehaelterAuftraege
{
  ...
  public interface IAklLeerbehaelterBestellung
  {
    ...
    /// <summary>
    /// Löscht einen LeerbehaelterAuftrag, den zugehörigen Teilauftrag, die zugehörige Einlagerreservierung, den zughörigen TordRequest 
    ...
    /// <summary>
    /// Liefert Query für Tablare zur Einlagerung
    /// </summary>
