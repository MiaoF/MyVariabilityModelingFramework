...
namespace Sgm.Mpl.MplAuftragAktivierung
{
	public class MplAuftragAktivierung : MplAuftragAktivierungBase
    {
        [RequiredProperty]
        
		public IMplMaterialErmittlung MplMaterialErmittlung { get; set; }  
        ...
        {
			MplMaterialErmittlung.Aufwecken();
        }
    }
    
  public class MplAuftragAktivierungBase : Zyklisch
  {
    //Logger
    ...
    {
      log.Info("Start MplAuftragAktivierung.ZyklischeAktion()");

      //TODO: add the code to implement local tasks:MplAuftragAktivierung
      NextStep();

      log.Info("Ende MplAuftragAktivierung.ZyklischeAktion()");
    }
